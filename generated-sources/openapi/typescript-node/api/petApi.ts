...
let defaultBasePath = 'https://virtserver.swaggerhub.com/wahibhanii/test/1.0.0';
...
export class PetApi {
     ...
     * @param body 
     */
    public async uploadFile (petId: number, body?: RequestFile, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: ApiResponse;  }> {
